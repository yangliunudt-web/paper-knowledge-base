...
| 论文 | 年份 | 核心发现 |
|------|------|----------|
| [[Surgical Fine-Tuning Improves Adaptation to Distribution Shifts\|Surgical Fine-Tuning Improves Adaptation...]] | 2023 | 提出选择性微调策略：只更新对分布偏移最敏感的参数子集。核心贡献是将参数敏感性分析系统化地引入fine-tuning，在保持性能的同时大幅减少更新参数量。来自Stanford，方法简洁但实用性强。 |
...
| [[Feature Alignment and Uniformity for Test Time Adaptation\|Feature Alignment and Uniformity for Tes...]] | 0 | - |

...
| 论文 | 年份 | 核心发现 |
|------|------|----------|
| [[A Voltage-Dependent Switching-Time Model for Ferroelectric Capacitors|A Voltage-Dependent Switching-Time Model for ...]] | 2004 | FeRAM 开关时间模型：Verilog-A、电压依赖动态、0.35μm CMOS/PZT、Spectre 仿真验证。 |
...
| [[Monolithic Integration of Oxide Semiconductor FET and Ferroelectric Capacitor for 3D Embedded RAM|Monolithic Integration of Oxide Semiconductor...]] | 2021 | IGZTO FET+FeRAM 单片集成：>20 cm²/V·s 迁移率、400°C 低温工艺、~ns 操作、3D 嵌入式 RAM、东京大学。 |

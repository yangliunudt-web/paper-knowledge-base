...
| 论文 | 年份 | 核心发现 |
|------|------|----------|
| [[Reservoir Computing Utilizing a Complementary Combination of n- and p-Channel FeFETs\|Reservoir Computing Utilizing a Compleme...]] | 2024 | n‑p FeFET互补组合实现储备池计算，利用器件互补特性提升非线性变换能力，结合反转数字输入可进一步优化性能。 |
...
| [[Ultralow‑power reservoir computing based on bidirectionally operable ferroelectric capacitors with tunable time constants\|Ultralow‑power reservoir computing based...]] | 2026 | 铁电电容器‑线性电容器串联器件实现超低功耗储备计算，具备双向操作和可调时间常数，在波形分类、多模态数字识别和 Mackey‑Glass 时间序列预测中表现优异。 |
## 相关概念

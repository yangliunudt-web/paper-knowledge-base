...
abstract_cn: "深度模型在封闭世界的许多视觉任务中取得了令人印象深刻的成就。然而，在我们不断变化的世界中，新类不时出现，需要学习系统不断获取新知识。类增量学习（CIL）使学习者能够增量地融合新类的知识，并在所有见过的类中构建通用分类器。本文全面综述了类增量学习的最新进展，并从多个方面总结了这些方法。我们还对基准图像分类任务中的\"
keywords:

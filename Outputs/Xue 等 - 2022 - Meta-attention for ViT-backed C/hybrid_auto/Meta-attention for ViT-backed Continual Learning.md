...
year: "2022"
journal: "IEEE TPAMI"
abstract: "Continual learning is a longstanding research topic due to its crucial role in AI safety and data privacy. Vision transformer (ViT) has shown promising potential in continual learning, but existing ViT-based methods overlook the attention mechanism, which is the core of ViT. This work proposes a meta-attention mechanism for ViT-backed continual learning, which learns to adaptively generate attention maps for tasks and effectively preserves knowledge."
abstract_cn: "持续学习因其在AI安全和数据隐私中的关键作用而成为长期研究课题。Vision Transformer（ViT）在持续学习中展现了有前景的潜力，但现有基于ViT的方法忽略了注意力机制这一ViT的核心。本文提出了一种面向ViT持续学习的元注意力机制，学习自适应地为任务生成注意力图并有效保留知识，在多个持续学习基准上取得了优异性能。"
keywords:
  - "[[Continual learning]]"
  - "[[Vision Transformer]]"
  - "[[Meta-attention]]"
  - "[[持续学习]]"
cite: "[1] Xue M, Zhang H, Song J, et al. Meta-attention for ViT-backed Continual Learning[J]. IEEE TPAMI, 2022."
aiSum: "提出面向ViT持续学习的元注意力机制，自适应生成任务注意力图保留知识，解决现有ViT方法忽略注意力机制的问题。在多个持续学习基准上性能优于现有方法。"
confidence: "medium"
wiki_concepts:

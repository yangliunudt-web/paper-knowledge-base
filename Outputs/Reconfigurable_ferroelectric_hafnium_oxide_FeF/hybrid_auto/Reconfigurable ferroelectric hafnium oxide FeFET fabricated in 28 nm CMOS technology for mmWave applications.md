---
title: "Reconfigurable ferroelectric hafnium oxide FeFET fabricated in 28 nm CMOS technology for mmWave applications"
authors:
...
keywords:
  ...
  - "[[HfO2]]"
  - "[[铁电]]"
abstract_cn: "本文介绍采用28nm CMOS技术制造的可重构多指FeFET。通过切换阈值电压，FeFET可在VGS=0下工作，减少操作能耗。器件采用共源配置，展示超过1V的存储窗口和毫米波频率下的优异性能。32×1um器件（80nm栅长）的fT=113GHz、fMAX=230GHz，为可重构RF FeFET中最高值。"
cite: "[1] Abdulazhanov S, Le Q H, Huynh D K, et al. Reconfigurable ferroelectric hafnium oxide FeFET fabricated in 28 nm CMOS technology for mmWave applications[J]. IEEE Electron Device Letters, 2023."
aiSum: "28nm CMOS工艺制造的多指FeFET可重构RF器件：fT=113GHz、fMAX=230GHz（可重构RF FeFET最高值），存储窗口>1V，VGS=0操作降低能耗，为毫米波可重构前端提供新型方案。"
confidence: "high"
  - "[[HfO₂]]"
  - "[[CMOS technology]]"
  - "[[mmWave]]"
